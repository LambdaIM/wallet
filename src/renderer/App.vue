<template>
    <div id="app">
        ...
        <Modal :title="$t('apppage.Modal1.Please_enter_password')" v-model="passwordModal" :styles="{ top: '200px' }">
            ...
            <div slot="footer">
                <Button
                    v-if="loadingsendLAMBTx == false"
                    :loading="loadingsendLAMBTx"
                    type="primary"
                    @click="TransferConfirmTimeOut"
                >
                    {{ $t('apppage.Modal1.Confirm') }}
                </Button>
