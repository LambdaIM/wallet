...
var walletRouter = new Router({
    routes: [
        ...
        },
        {
            ...
            component: () => import('@/views/Home/indexMenu.vue'),
        },
        {
            path: '/localtxlist',
            name: 'localtxlist',
        ...
        },
        {
            path: '/success',
            name: 'Success',
            component: () => import('@/views/account/Register/Success.vue'),
        },
        {
            path: '/export',
            name: 'Export',
            component: () => import('@/views/account/Register/Export.vue'),
        },
        {
            path: '/detail/:id',
            name: 'detail',
        ...
        },
        {
            path: '/import',
            name: 'Import',
            component: () => import('@/views/account/Import.vue'),
        },
        {
            path: '/settings',
            name: 'Settings',
        ...
        },
        {
            ...
            name: 'Stakinginfo',
            component: () => import('@/views/staking/Stakinginfo.vue'),
        },
        ...
        },
        {
            ...
            name: 'proposalinfo',
            component: () => import('@/views/proposal/info.vue'),
        },
        {
            path: '/market',
            name: 'market',
        ...
        },
        {
            path: '/orderinfo/:id',
            name: 'orderinfo',
            component: () => import('@/views/market/orderinfo.vue'),
        },
        {
            path: '/sign',
            name: 'sign',
