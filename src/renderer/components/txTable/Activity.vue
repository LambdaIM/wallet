...
export default {
  ...
  data() {
    return {
      ...
      Asset: ['MsgCreateAsset', 'MsgMintAsset', 'MsgLockAsset', 'MsgUnLockAsset', 'MsgDestroyAsset', 'MsgRuinAsset', 'MsgCreateDigitalAssetMarket',
        'MsgDismissDigitalAssetMarket', 'MsgAuthorizeMiningPubKey', 'MsgDigitalAssetPledge', 'MsgDigitalAssetRefund'],
