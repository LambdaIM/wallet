<template>
    <div class="head-container">
        <Row class="head-wrapper">
            <Col span="4" class-name="head-logo-wrapper">
                <img src="../../../assets/img/logosvg.svg" class="head-logo" alt="lambda" />
            </Col>

            <Col span="18" offset="1" v-if="login == true" class-name="head-menu-wrapper">
                <div class="head-menu">
                    <div class="head-menu-item">
                        <router-link to="/home" class="item">{{ $t('head.home') }}</router-link>
                    </div>
                    <div class="head-menu-item">
                        <router-link to="/staking" class="item">{{ $t('head.validator') }}</router-link>
                    </div>
                    <!-- <div class="head-menu-item">
          <router-link
            to="/partner"
          ...
          >{{ $t("head.partner") }}</router-link>
                    ...
                    <div v-if="$role('menu.market')" class="head-menu-item">
                        <router-link to="/markethome" class="item">{{ $t('head.market') }}</router-link>
                    </div>

                    <div class="head-menu-item">
                        <router-link to="/proposal" class="item">{{ $t('head.proposals') }}</router-link>
                    </div>

                    <div class="head-menu-item" v-if="$role('home.guide')">
                        <router-link to="/guide" class="item">
                            ...
                            <a href="javascript:void(0)" style="color:white">
                                <span>
                                    <svg
                                        ...
                                        height="25"
                                    >
                                        <path d="M0 859.7h1024V177.3H0z" fill="#00458F" p-id="2303"></path>
                                        <path
                                ...
                                >
                                    <path
                                        ...
                                        p-id="3100"
                                    ></path>
                                    <path d="M8.806 2.516H1536v1017.71H8.806z" fill="#D64B24" p-id="3101"></path>
                                    <path
