            ...
            <Badge :type="getNetColour" :text="networkType"></Badge>
                ...
                <Dropdown @on-click="Switchnetwork">
                    <a style="color:white" href="javascript:void(0)">
                        <Icon :color="getNetColour" type="md-cloud" />
                        {{ networkType }}
                        <Icon type="ios-arrow-down"></Icon>
                    </a>

                    <DropdownMenu slot="list">
                        <DropdownItem name="mainnet" style="text-align: left;">
                            <Icon color="#19be6b" type="md-cloud" />
                            {{ $t('foot.defaultmaster') }}
                        </DropdownItem>
                        <DropdownItem name="testnet" style="text-align: left;">
                            <Icon color="#FFC125" type="md-cloud" />
                            {{ $t('foot.Defaulttestnode') }}
                        </DropdownItem>
                        <DropdownItem v-if="login" name="customnet" style="text-align: left;" divided>
                            <Icon color="#EE30A7" type="md-cloud" />
                            {{ $t('foot.Customnode') }}
                        </DropdownItem>
                    </DropdownMenu>
                </Dropdown>
