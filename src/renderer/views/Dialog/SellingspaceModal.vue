    ...
    <div>
        ...
        >
            <Form @keydown.native.enter.prevent="prewithdrawalLAMB">
                <p>{{ $t('Dialog.sellorder.Marketaddress') }}：{{ market.marketAddress }}</p>
                <br />
                <p>{{ $t('Dialog.sellorder.Marketname') }}：{{ market.name }}</p>
          ...
          <span slot="append">{{$t('Dialog.sellorder.times')}}</span>
                    ...
                    <RadioGroup @on-change="ratechangedebounce" v-model="rate">
                        ...
                        <Radio value="1" label="1">
                            <span>{{ $t('somemodel.highquality') }}</span>
                        </Radio>
                    </RadioGroup>
                </p>
                <br />
                ...
                <br />
                <p>
                    {{ $t('Sellingothers.Compensation') }}：{{ Compensation }} LAMB &nbsp;&nbsp;
                    {{ $t('Sellingothers.ServiceCharge') }}：{{ Handlingfee }} LAMB &nbsp;&nbsp;
                    <br />
