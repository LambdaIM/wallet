    ...
    <div>
        ...
        >
            <Form @keydown.native.enter.prevent="preSendLAMB">
                ...
                <br />
                <p v-if="isNaN(Compensation) == false">
                    {{ $t('Marketothers.pledgeassets') }}：{{ Compensation }} {{ AssetName | assertdenomformat }}
                </p>
                <p>
                    {{ $t('AuthorizeMarketpledge.tip1') }}
                    <br />
                    {{ $t('AuthorizeMarketpledge.tip2') }}
                    <br />
