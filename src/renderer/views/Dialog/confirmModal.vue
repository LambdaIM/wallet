            ...
            <Form @keydown.native.enter.prevent="confirm">
                ...
                <div v-if="txtype == 'withdrawal'">
                    ...
                    <Row class-name="item" v-if="transactiondata.amount">
                        ...
                        <Col span="20" class-name="value">
                            {{ transactiondata.amount | BlanceValue }} {{ denomShort(transactiondata.denom) }}
                        </Col>
                    </Row>
                </div>
                ...
                <div v-if="txtype == 'redelegate'">
                    ...
                    <Row class-name="item">
                        ...
                        <Col span="20" class-name="value address">
                            {{ transactiondata.validatorDestinationAddress }}
                        </Col>
                    </Row>
                    <Row class-name="item">
                        <Col span="4" class-name="key">{{ $t('home.Modal1.Amount') }}:</Col>
                ...
                <div v-if="txtype == 'AssetPledge'">
                    ...
                    <Row v-if="transactiondata.type == 'MsgAssetPledge'" class-name="item">
                        <Col span="4" class-name="key">{{ $t('home.Modal1.Amount') }}:</Col>
                        <Col span="20" class-name="value">
                            {{ transactiondata.amounts.amount | BlanceValue }} LAMB {{ $t('Dialog.com.to') }}
                            {{ transactiondata.asset.amount | BlanceValue }} TBB
                        </Col>
                    </Row>
                    <Row v-else class-name="item">
                        <Col span="4" class-name="key">{{ $t('home.Modal1.Amount') }}:</Col>
                        <Col span="20" class-name="value">
                            {{ transactiondata.asset.amount | BlanceValue }} TBB {{ $t('Dialog.com.to') }}
                            {{ transactiondata.amounts.amount | BlanceValue }} LAMB
                        </Col>
                    </Row>
                </div>
                ...
                <div v-if="txtype == 'deposit'">
                    ...
                    <Row class-name="item">
                        <Col span="4" class-name="key">{{ $t('home.Modal1.Amount') }}:</Col>
                        <Col span="20" class-name="value">
                            {{ transactiondata.amounts[0].amount | BlanceValue }}
                            {{ denomShort(transactiondata.amounts[0].denom) }}
                        </Col>
                    </Row>
                </div>
                ...
                <div v-if="txtype == 'CreateBuyOrder'">
                    ...
                    <Row
                        class-name="item"
                        v-if="transactiondata.sellOrderId && transactiondata.sellOrderId != '[do-not-input-value]'"
                    >
                    ...
                    <Row class-name="item">
                        ...
                        <Col span="20" class-name="value">
                            {{ transactiondata.duration | formatMonth }} {{ $t('Dialog.AutoBuy.month') }}
                        </Col>
                    </Row>
                </div>
                <div v-if="txtype == 'CreateSellOrder'">
                    ...
                    <Row class-name="item">
                        ...
                        <Col span="20" class-name="value">
                            {{ transactiondata.price | BlanceValue }} {{ $t('Dialog.sellorder.unitprice2') }}
                        </Col>
                    </Row>
                    <Row class-name="item">
                        <Col span="4" class-name="key">{{ $t('Dialog.sellorder.Odds') }}:</Col>
                        <Col span="20" class-name="value">
                            {{ parseFloat(transactiondata.rate).toFixed(2) }} {{ $t('Dialog.sellorder.times') }}
                        </Col>
                    </Row>
                    <Row class-name="item">
                    ...
                    <Row class-name="item">
                        ...
                        <Col span="19" class-name="value">
                            {{ transactiondata.minBuyDuration | formatMonth }} {{ $t('Dialog.sellorder.month') }}
                        </Col>
                    </Row>
                    <Row class-name="item">
                        <Col span="5" class-name="key">{{ $t('Dialog.sellorder.Maximumtime') }}:</Col>
                        <Col span="19" class-name="value">
                            {{ transactiondata.maxBuyDuration | formatMonth }} {{ $t('Dialog.sellorder.month') }}
                        </Col>
                    </Row>
                </div>
                ...
                <div v-if="txtype == 'OrderRenewal'">
                    ...
                    <Row class-name="item">
                        ...
                        <Col span="20" class-name="value">
                            {{ transactiondata.duration | formatMonth }}{{ $t('Dialog.sellorder.month') }}
                        </Col>
                    </Row>
                    <Row class-name="item">
                ...
                <div v-if="txtype == 'DigitalAssetPledge'">
                    ...
                    <Row class-name="item">
                        ...
                        <Col span="16" class-name="value">
                            {{ transactiondata.Price | BlanceValue
                            }}{{ transactiondata.AssetName | assertdenomformat }}/GB/month
                        </Col>
                    </Row>
                </div>
                ...
                <div v-if="txtype == 'assertDamCreateBuyOrder'">
                    ...
                    <Row class-name="item">
                        ...
                        <Col span="21">{{ transactiondata.Size }}GB</Col>
                    </Row>
                    <Row class-name="item">
                        <Col span="3" class-name="key">{{ $t('Purchasespace.Size') }}:</Col>
                        <Col span="21">
                ...
                <div v-if="otherData != null">
                    ...
                    <div v-if="txtype == 'DigitalAssetPledge'">
                        <Row class-name="item">
                            ...
                            <Col span="6" class-name="value">
                                {{ otherData.totalAmount }} {{ transactiondata.AssetName | assertdenomformat }}
                            </Col>
                        </Row>
                    </div>
                    <div v-if="txtype == 'DamOrderRenewal'">
                        <Row class-name="item">
                            <Col span="6" class-name="key">{{ $t('Dialog.AutoBuy.Paymentamount') }}:</Col>
                            <Col span="6" class-name="value">
                                {{ otherData.totalAmount | BlanceValue }} {{ otherData.denom | assertdenomformat }}
                            </Col>
                        </Row>
                    </div>
                    <div v-if="txtype == 'assertDamCreateBuyOrder'">
