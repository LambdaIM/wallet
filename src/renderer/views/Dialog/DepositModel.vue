<template>
    <div>
        <Modal loading v-model="sendModal" :title="isdegeTxt" :styles="{ top: '200px' }" @on-cancel="sendcancel">
            <Form @keydown.native.enter.prevent="preSendLAMB">
                ...
                <br />
                <p>{{ $t('home.Balance') }} : {{ balanceLamb | Lambformat }}</p>
                <br />
                <p>
                    {{ $t('Dialog.DepositModel.tip1') }}
                    <br />
                    <span style="color:red">{{ $t('Dialog.DepositModel.tip2') }}</span>
                    <br />
                    {{ $t('Dialog.DepositModel.tip3') }}
                    <br />
                    {{ $t('Dialog.DepositModel.tip4') }}
                    <br />
