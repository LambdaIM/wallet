      ...
      <div class="content" slot="card-content">
        ...
        <Row class-name="card-item">
          ...
          <Col span="18" class-name="content-wrapper">
            <a  class="item-value"> <Input type="textarea"  :autosize="{minRows: 2,maxRows: 10}"  v-model="jsondata"  style="width:100%" readonly/>

             </a>
          </Col>
          <Col span="2" class-name="content-wrapper" style="text-align: center;">
            <Button
