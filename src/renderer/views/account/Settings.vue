        ...
        <div class="setting-wrapper">
            ...
            ></Button>
                    ...
                    <Row class-name="card-item">
                        ...
                        <Col span="12" class-name="content-wrapper">
                            <span>{{ Gasprisevalue }}uLAMB</span>
                            <Button @click="opengasprise" type="primary" shape="circle" icon="ios-create"></Button>
                        </Col>
                    </Row>
                    <!-- <Row class-name="card-item">
            <Col
            ...
            <Mycard v-if="getstore.length > 0" :cardtitle="$t('seting.Validator_Node_info')" class="mb10">
                <div class="storage-content" slot="card-content">
                    ...
                    <Row class-name="card-item">
                        ...
                        <Col span="12" class-name="content-wrapper">
                            <span>
                                <router-link to="/validator" class="item">
                                    {{ $t('seting.Switch_Validator') }}
                                </router-link>
                            </span>
                        </Col>
                    </Row>
