            ...
            <div class="demo-tabs-style2">
                <Tabs value="name1">
                    <TabPane :label="$t('Import.by_keyStore_file')" name="name1">
                        <Form
                            @keydown.native.enter.prevent="handleSubmit('formbyfile')"
                            ref="formbyfile"
                            :model="formInline"
                            :rules="ruleInline"
                        ...
                        >
                            <FormItem prop="keystorefile">
                                <Upload
                                    ...
                                    action
                                >
                                    <Button class="btn upload-button" icon="ios-cloud-upload-outline">
                                        {{ $t('Import.Choose_Wallet_Files') }}
                                    </Button>
                                </Upload>
                            </FormItem>
                        ...
                        <div class="button-wrapper">
                            <button class="btn login-button" @click="handleSubmit('formbyfile')">
                                {{ $t('Import.Import') }}
                            </button>
                        </div>
                    </TabPane>
                    ...
                    <TabPane :label="$t('Import.by_mnemonic_word')" name="name2">
                        <div v-if="review == false">
                            ...
                            <div class="button-wrapper">
                                <button class="btn login-button" @click="handleSubmit('formInMnemonic')">
                                    {{ $t('Import.preview') }}
                                </button>
                            </div>
                        </div>
                        <div v-else>
                            <h2 style="color: white;margin-bottom: 15px">
                                {{ $t('Import.name') }}：{{ Mnemonic.walletname }}
                            </h2>
                            ...
                            <div style="text-align: center;">
                                ...
                                &nbsp;&nbsp;
                                <Button class="btn login-button" @click="importWord">{{ $t('Import.Import') }}</Button>
                            </div>
                            <br />
                            <br />
                        </div>
...
export default {
    ...
    computed: {
        worldList() {
            ...
            var mnemonicList = mnemonic.match(/[a-z]+[\-\']?[a-z]*/gi);
