      ...
      >
        ...
        <Row class-name="card-item">
          ...
          <a
            ...
            class="item-value"
          >{{validator.description.moniker}}</a>
          </Col>
          <Col
            span="4"
            class-name="title-wrapper"
          ...
          <Button type="primary">取消质押</Button>
          </Col>
        </Row>
        ...
        <Row class-name="card-item">
          ...
          >
          <a class="item-value"
          >{{validator.commission.max_rate}}</a>
          </Col>
        </Row>
        <Row class-name="card-item">
          <Col
          ...
          >
          <a class="item-value"
          >{{validator.commission.max_change_rate}}</a>
          </Col>
        </Row>
        <Row class-name="card-item">
          <Col
          ...
          >
          <a class="item-value"
          >{{validator.tokens/pool.bonded_tokens}}</a>
          </Col>
        </Row>
