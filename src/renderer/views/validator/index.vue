            ...
            <span slot="prepend">Validator Url2</span>
             ...
             <Button @click="settestip"  type="info" ghost >{{$t("foot.DefaulttestnetworkIP")}}</Button>
                    ...
                    <FormItem @click="settestip" prop="ValidatorIP" :label="$t('Validator.ip')">
                        <Input
                            type="text"
                            v-model="formInline.ValidatorIP"
                            :placeholder="$t('Validator.Validator_node')"
                        ></Input>
                    </FormItem>

                    <FormItem>
                        <Button :loading="loadingbtn" type="primary" @click="handleSubmit('formInline')">
                            {{ $t('Validator.submit') }}
                        </Button>
                        &nbsp; &nbsp; &nbsp; &nbsp;
                ...
                <div class="storage-content" slot="card-content">
                    <Row v-for="item in sync_info" class-name="card-item">
                        ...
                        <Col span="12" class-name="content-wrapper">
                            ...
                            <span style="color:red" v-if="item[0] == 'catching_up' && item[1] == true">
                                {{ $t('Validator.Sync_Block') }}
                            </span>
                        </Col>
                    </Row>
                </div>
